...
process.TFileService = cms.Service("TFileService",
    fileName =cms.string('TTree_MC_evt1k_v8.root'))
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
       #'root://xrootd-cms.infn.it//store/mc/HINPbPbSpring23MiniAOD/promptD0ToKPi_PT-1_TuneCP5_5p36TeV_pythia8-evtgen/MINIAODSIM/132X_mcRun3_2023_realistic_HI_v9-v2/2560000/04335bea-a283-40ea-a050-d71e1b7fac6b.root'
        ...
        'root://xrootd-cms.infn.it//store/mc/HINPbPbSpring23MiniAOD/promptD0ToKPi_PT-10_TuneCP5_5p36TeV_pythia8-evtgen/MINIAODSIM/132X_mcRun3_2023_realistic_HI_v9-v1/2820000/26f764e5-fc1b-4014-8ec8-bc93ca1a6f0c.root'
...
#For Data and Mc centrality!!
process.eventinfoana.isMC_cent = cms.untracked.bool(True) # Centrality
process.d0ana_newreduced.isMC_cent = cms.untracked.bool(True) # Centrality
process.d0selectorNewReduced.isMC_cent = cms.untracked.bool(True) # Centrality                                                                                          
process.eventinfoana.isData_cent = cms.untracked.bool(False) # Centrality 
process.d0ana_newreduced.isData_cent = cms.untracked.bool(False) # Centrality 
process.d0selectorNewReduced.isData_cent = cms.untracked.bool(False) # Centrality
...
#process.TriggerProcessing = cms.Path(process.eventFilter_HLT)

# Then, run analyses on the filtered events
'''
process.Analysis = cms.Path(
    process.generalD0CandidatesNew *
    process.d0ana_seq2 
    #process.eventinfoana
)
'''
...
#process.schedule = cms.Schedule(process.EventSelections, process.TriggerProcessing, process.Analysis, process.EventInfoAnalysis)
