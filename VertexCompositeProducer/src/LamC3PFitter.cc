...
*/    
	...
	for (int j = 0; j < 3; ++j)
      ...
      /*std::cout << "[CAND1] pt: " << cand1.pt()
          << ", eta: " << cand1.eta()
          << ", phi: " << cand1.phi()
          << ", charge: " << cand1.charge()
          << ", numberOfHits(): " << cand1.numberOfHits()
          << ", hasTrackDetails(): " << cand1.hasTrackDetails()
          << std::endl;
      */
      ...
      if (cand1.hasTrackDetails()) {
	theCand1.setTrack(cand1.track());
      }
      ...
      if (cand2.hasTrackDetails()) {
	theCand2.setTrack(cand2.track());
      }
      ...
      if (cand3.hasTrackDetails()) {
	theCand3.setTrack(cand3.track());
	}*/
      ...
      if (cand1.hasTrackDetails()) {
	reco::TrackRef tkref1 = cand1.bestTrackRef();
	if (tkref1.isNonnull() && tkref1.isAvailable()) {
	  theCand1.setTrack(tkref1);
	}
      }
      ...
      if (cand2.hasTrackDetails()) {
	reco::TrackRef tkref2 = cand2.bestTrackRef();
	if (tkref2.isNonnull() && tkref2.isAvailable()) {
	  theCand2.setTrack(tkref2);
	}
      }
      ...
      if (cand3.hasTrackDetails()) {
	reco::TrackRef tkref3 = cand3.bestTrackRef();
	if (tkref3.isNonnull() && tkref3.isAvailable()) {
	  theCand3.setTrack(tkref3);
	}
      }
      ...
      */
      ...
      if (cand1.hasTrackDetails()) {
	const reco::Track* trkPtr1 = cand1.bestTrack();
	if (trkPtr1) {
	  for (size_t i = 0; i < trackHandle->size(); ++i) {
	    if (&(*trackHandle)[i] == trkPtr1) {
	      reco::TrackRef tkref1(trackHandle, i);
	      theCand1.setTrack(tkref1);
	      break;
	    }
	  }
      ...
      if (cand2.hasTrackDetails()) {
	const reco::Track* trkPtr2 = cand2.bestTrack();
	if (trkPtr2) {
	  for (size_t i = 0; i < trackHandle->size(); ++i) {
	    if (&(*trackHandle)[i] == trkPtr2) {
	      reco::TrackRef tkref2(trackHandle, i);
	      theCand2.setTrack(tkref2);
	      break;
	    }
	  }
      ...
      if (cand3.hasTrackDetails()) {
	const reco::Track* trkPtr3 = cand3.bestTrack();
	if (trkPtr3) {
	  for (size_t i = 0; i < trackHandle->size(); ++i) {
	    if (&(*trackHandle)[i] == trkPtr3) {
	      reco::TrackRef tkref3(trackHandle, i);
	      theCand3.setTrack(tkref3);
	      break;
	    }
	  }
