...
process.lamc3pselector.centralitySrc = cms.InputTag("hiCentrality") #central
process.lamc3pselector.centMin = cms.untracked.int32(0)
process.lamc3pselector.centMax = cms.untracked.int32(200)
