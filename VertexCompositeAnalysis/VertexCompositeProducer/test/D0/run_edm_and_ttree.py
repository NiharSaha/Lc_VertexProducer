...
process.TFileService = cms.Service("TFileService",
    fileName =cms.string('TTree_wCentbin_evt5k_HLT.root'))
...
process.EventSelections = cms.Path(process.centralityBin * process.eventFilter_HM * process.event_filters * process.generalD0CandidatesNew * process.d0ana_seq2)
